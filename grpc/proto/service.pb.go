...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	0x45, 0x8a, 0x1f, 0xce, 0x87, 0x1a, 0xa7, 0xcd, 0xc5, 0x11, 0x5c, 0x9a, 0x54, 0x52, 0x54, 0x9a,
	0x5c, 0x42, 0x50, 0x71, 0x12, 0x1b, 0x98, 0x6f, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x9c, 0xea,
	0x9b, 0xd8, 0xcd, 0x00, 0x00, 0x00,
}
...
func (*UnimplementedMathServiceServer) Subtract(ctx context.Context, req *Request) (*Response, error) {
...
func _MathService_Subtruct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
...
var _MathService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Subtract",
			Handler:    _MathService_Subtruct_Handler,
		},
	},
